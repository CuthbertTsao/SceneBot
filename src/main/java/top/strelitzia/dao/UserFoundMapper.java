...
public interface UserFoundMapper {
    ...
    //写入今日老婆
    Integer updateTodayWifeByQq(@Param("qq") Long qq, @Param("todayWife") Long todayWife, @Param("wifeGroup") Long wifeGroup);

    //重置本群今日老婆
    Integer resetGroupWife(@Param("wifeGroup") Long wifeGroup);
